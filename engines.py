...
from models import CP, ComplEx, TransE, RESCAL, TuckER, UniBi_2, UniBi_3, RotatE
...
def setup_model(opt):
    if opt['model'] == 'TransE':
        ...
        model = UniBi_2(opt['size'], opt['rank'], opt['init'], opt['rel_norm'], opt['ent_norm'], opt['regularizer'])
