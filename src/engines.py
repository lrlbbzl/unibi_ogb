...
from models import CP, ComplEx, TransE, RESCAL, TuckER, UniBi_2
from regularizers import F2, N3, DURA_UniBi_2
...
def setup_model(opt):
    ...
    elif opt['model'] == 'UniBi_2':
        model = UniBi_2(opt['size'], opt['rank'], opt['init'], opt['rel_norm'], opt['regularizer'])
